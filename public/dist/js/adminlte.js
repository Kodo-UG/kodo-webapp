...
(function (global, factory) {
	...
	var ControlSidebar = /*#__PURE__*/ (function () {
		...
		_proto._fixHeight = function _fixHeight() {
			...
			if (
				typeof $__default["default"].fn.overlayScrollbars !== "undefined"
			) {
	...
	var IFrame = /*#__PURE__*/ (function () {
						...
						$__default["default"](tabId + " iframe")
							...
							.ready(function () {
								if (_this2._config.loadingScreen) {
									if (
										typeof _this2._config.loadingScreen === "number"
									) {
										setTimeout(function () {
											$loadingScreen.fadeOut();
		...
		_proto.toggleFullscreen = function toggleFullscreen() {
			if (
				$__default["default"]("body").hasClass(CLASS_NAME_FULLSCREEN_MODE)
			) {
	...
	var PushMenu = /*#__PURE__*/ (function () {
		...
		_proto.toggle = function toggle() {
			if (
				$__default["default"](SELECTOR_BODY).hasClass(CLASS_NAME_COLLAPSED)
			) {
				this.expand();
			} else {
				this.collapse();
